...
def main():
    ...
    try:
        con.execute("ALTER TABLE events_raw ADD COLUMN status TEXT")  # 기존 DB(이 컬럼 없이 만들어진 것) 마이그레이션
